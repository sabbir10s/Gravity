    ...
    <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full">
      <div className="text-center">
        <div className="inline-flex rounded-full bg-yellow-100 p-4">
          <div className="rounded-full stroke-[#D19715] bg-[#FEF08A] p-4">
        ...
        <div>
          <button
            onClick={() => navigate("/")}
            className="bg-primary-800 text-white px-8 py-2 transition duration-300 ease-in-out hover:bg-secondary-500 mt-5 shadow-custom_secondary"
          >
            Back to Home
          </button>
        </div>
