      ...
      <div>
        ...
        <section ref={sectionRef}>
          {isVisible ? (
            ...
            <div className="container mt-[32px] lg:mt-[60px] w-full flex items-center justify-center relative z-0 duration-1000">
        ...
        <div className="container lg:flex justify-between items-start mt-[40px] md:mt-[50px] lg:py-[80px]">
          <h2 className="text-[20px] md:text-[24px] lg:text-[50px]">About</h2>
          <p className="mt-[12px] lg:mt-0 lg:w-3/4 text-[16px] md:text-[19px] lg:text-[24px]">
            Gravity is a fast growing digital agency that specializes in providing first-rate
            <span className="text-[#1DFF77]">IT</span>
            and <span className="text-[#1DFF77]">digital branding services</span>. With a team of experienced professionals who are passionate about
            technology and creativity, Gravity has made a name for itself for providing innovative solutions that help businesses of all sizes grow
            and succeed in todays digital landscape.
          </p>
        </div>
      </div>
