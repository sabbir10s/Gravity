    ...
    <div className="bg-primary-800 text-white py-[52px]">
      <div className="container">
        ...
        <div className="bg-[#23C162] mt-[32px] lg:mt-[60px] w-full flex items-center justify-center relative">
          ...
          <img className=" cursor-pointer absolute w-[56px] md:w-[100px] lg:w-[200px] h-[56px] md:h-[100px] lg:h-[200px]" src={play} alt="" />
        </div>
        <div className="lg:flex justify-between items-start mt-[40px] md:mt-[50px] lg:mt-[80px]">
          ...
          <p className="mt-[12px] lg:mt-0 lg:w-3/4 text-[16px] md:text-[19px] lg:text-[24px]">
            Gravity is a fast growing digital agency that specializes in providing first-rate <span className="text-[#1DFF77]">IT</span> and{" "}
            <span className="text-[#1DFF77]">digital branding services</span>. With a team of experienced professionals who are passionate about
