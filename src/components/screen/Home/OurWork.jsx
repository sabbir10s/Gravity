  ...
  return (
    <div className="bg-[#fafcfe]">
      <div className="container py-12">
        <h2 className=" text-secondary-800 text-[36px] lg:text-[64px] font-semibold">What we do?</h2>
        <div>
          <div className="py-[24px] lg:mt-[48px] lg:border-t border-[#EDF0F2] lg:grid grid-cols-2">
            ...
            <div className="lg:grid grid-cols-2 mt-[12px] lg:text-[20px]">
              <ul className="disk ml-8 text-secondary-800/80">
                <li>Research & Data</li>
          ...
          <div className="py-[24px] border-t border-[#EDF0F2] lg:grid grid-cols-2">
            ...
            <div className="lg:grid grid-cols-2 mt-[12px] lg:text-[20px]">
              ...
              <ul className=" ml-8 text-secondary-800/80">
