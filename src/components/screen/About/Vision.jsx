...
const Vision = () => {
  return (
    <section className="container text-secondary-800 flex flex-col lg:flex-row lg:gap-[130px] ">
      <div className="pr-0 lg:pr-3 pt-[52px] lg:pt-[100px] order-2 lg:order-none lg:w-2/3">
        ...
        <div className="w-24 h-[7px] my-5 bg-primary-800"></div>
        <p className="text-base md:text-[20px] lg:text-[24px] xl:text-[22px] 2xl:text-[32px] md:leading-relaxed lg:leading-[48px] mt-[24px]">
