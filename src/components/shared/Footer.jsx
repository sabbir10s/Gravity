...
const Footer = () => {
    return <div className="bg-secondary-800 text-white">
        <div className="pt-[60px]">

            <div className='flex items-center justify-between container'>
                <div>
                    <h3 className="text-[20px] lg:text-[30px]">Have a project in mind?</h3>
                    <h2 className="text-[24px] lg:text-[45px] font-semibold">Let’s get to work.</h2>
                </div>
                <a href="#"><img src={arrow} alt=""/></a>
            </div>

            <div className='mt-[40px] lg:mt-[80px] lg:flex justify-between container'>
                <div>
                    <p className=' text-white/40 text-[16px] lg:text-[20px] uppercase'>Email</p>
                    <h4 className='text-[20px] lg:text-[30px] lg:mt-[10px]'>hello@gravity.co</h4>
                </div>
            ...
            <div className='container lg:flex justify-between'>
                ...
                <div>
                    ...
                    <p className=' text-[20px] mt-[10px]'>Uttara, Sector- 4,
                        <br/>
                        Dhaka, Bangladesh</p>
